...
net = caffe.Net('/home/satish_kumar/code/basicnet_deploy.prototxt',
                '/home/satish_kumar/code/basicnet_model_iter_10000.caffemodel',
                caffe.TEST)
